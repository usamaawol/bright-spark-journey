...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An English communication academy for complete beginners. Learn through speaking, real practice, and confidence-building." },
      { name: "author", content: "Bright Spark English Academy" },
